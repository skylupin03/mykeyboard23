...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * │ 0     │ . │   │
     * └───────┴───┴───┘ */
    [WIN_BASE] = LAYOUT(KC_ESC,       KC_TAB,   KC_BSPC,        MO(1),
     ...
     * │Insert │Del│   │
     * └───────┴───┘───┘*/
    [WIN_FN] = LAYOUT(  KC_CALC, KC_WINM,  KC_MACM,  _______,
    ...
    [MAC_BASE] = LAYOUT(KC_ESC,       KC_TAB,    KC_BSPC,     MO(3),
    ...
    [MAC_FN] = LAYOUT(  KC_CALC, KC_WINM,  KC_MACM,  _______,
                        _______, _______, _______,    EE_CLR,
                        _______, _______, _______,    QK_RBT,
                        RGB_SPI, RGB_HUI,  RGB_SAI,
                        RGB_SPD, RGB_HUD,  RGB_SAD,  QK_BOOT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [WIN_BASE] = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [WIN_FN]   = { ENCODER_CCW_CW(RGB_SAD, RGB_SAI), ENCODER_CCW_CW(RGB_VAD, RGB_VAI) },
    [MAC_BASE] = { ENCODER_CCW_CW(KC_MS_U, KC_MS_D), ENCODER_CCW_CW(KC_MS_L, KC_MS_R) },
    [MAC_FN]   = { ENCODER_CCW_CW(KC_WH_U, KC_WH_D), ENCODER_CCW_CW(KC_WH_L, KC_WH_R) }
};
//#endif
