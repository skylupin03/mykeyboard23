...
#define MATRIX_ROW_PINS { B0, B1, B3, B4, B5, B8 } 
#define MATRIX_COL_PINS { A0, A1, A2, B9 }     
...
/* RGB Encoder (LED의 +핀이 스위치핀과 같이 사용하기에 스위치를 matrix구성하면 LED 사용불가)*/
#define LED_e0_R	A3         // Encoder 0 RGB LED, pin 13
#define LED_e0_G	A4         // pin 14
#define LED_e0_B	A5         // pin 15
#define LED_e1_R	A6         // Encoder 1 RGB LED, pin 16
#define LED_e1_G	A7         // pin 17
#define LED_e1_B	A9         // pin 30
...
/* Encoder used pins */
#define ENCODERS_PAD_A { B12, B14 }  // pin 25, 27
#define ENCODERS_PAD_B { B13, A15 }  // pin 26, 38

/* Specifies the number of pulses the encoder registers between each detent */
#define ENCODER_RESOLUTIONS { 2, 2 }       //#define ENCODER_RESOLUTIONS 2  //4
...
#define WS2812_DI_PIN B15    // The pin connected to the data pin of the LEDs
...
#define LED_MATRIX_CENTER {35, 27}
