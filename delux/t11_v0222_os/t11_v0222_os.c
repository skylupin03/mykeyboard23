...
led_config_t g_led_config = { // K20 Key Matrix & 31FL3731 KEYBOARD LED TEST array (Mechanic RGB layout) (made at SKYDIGITAL)
    {        // Key Matrix to LED Index
        {  0,  1,  2,  3,___,___,___,___},\
        { 11, 10,  9,  8,  7,  6,  5, 4 },\
        { 12, 13, 14, 15, 16, 17, 18,___},\
        { 23, 22, 21, 20, 19,___,___,___},\
        { 24, 25, 26, 27, 28,___,___,___}\
    }, {
        // LED Index to Physical Position 
                    {  0,  9},          {  0, 22},    {  0, 31},    {  0, 40}, 
        { 14,  0},   { 14,  9},   { 14, 18},   { 14, 27},   { 14, 36},   { 14, 45},   { 14, 54},   { 14, 63},
        { 29,  4},      { 29, 13},   { 29, 22},   { 29, 31},   { 29, 40},   { 29, 49},       { 29, 63},
        { 43,  4},             { 43, 18},   { 43, 27},   { 43, 36},   { 43, 45},
        { 57,  0},   { 57,  9},   { 57, 18},   { 57, 45},                          { 57, 63}
    }, {
        // LED Index to Flag
        4, 8, 8, 8, 
        4, 4, 4, 4, 4, 4, 4, 4, 
