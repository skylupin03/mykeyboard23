...
// This a shortcut to help you visually see your layout. -- 230511 Rev A1 PCB 오류, K69->k67, K68->K69, K67->K68 로 변경 (LED 매트릭스도 같이 변경)
#define LAYOUT_fullsize_ansi( \
    K00,        K01,  K02,  K03,  K04,  K05,  K06,  K07,  K08,  K09,  K0A,  K0B,  K0C,      K0D,  K0E,  K0F,                    K70,  \
    K10,  K11,  K12,  K13,  K14,  K15,  K16,  K17,  K18,  K19,  K1A,  K1B,  K1C,  K1E,      K2E,  K2F,  K1F,      K6A, K67, K69, K68, \
    ...
    { K70,  XXX,  XXX,  XXX,  XXX,  XXX,  XXX,  K77,  K78,  K79,  K7A,  K7B,  K7C,  K7D,  K7E,  K7F }   \
}
